        ...
        <>
            <div class="page_wrap" id='Contact'>
                ...
                <div id='divSplitContact'>
                    <div id='inner-div'>
                        <h3>Recruitment</h3>
                        <p>We've got a really great community, if you're interested in seeing if we're the right fit. contact: Cookadile Dundee (EU Time Zone) or Lal (US Time Zone) in game or join our discord channel.</p>
                    </div>
                    <div id='inner-div'>
                        <h3>Diplomacy</h3>
